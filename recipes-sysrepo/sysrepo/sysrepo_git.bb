...
SRC_URI = "git://github.com/pointerdk/cco-sysrepo.git;protocol=https file://sysrepo"
...
EXTRA_OECMAKE = " -DCMAKE_INSTALL_PREFIX:PATH=/usr -DCMAKE_BUILD_TYPE:String=Release -DCMAKE_C_FLAGS_DEBUGLString=O2 -DUSE_SR_MEM_MGMT:Bool=OFF -DBUILD_EXAMPLES:String=False -DENABLE_TESTS:String=False -DREPOSITORY_LOC:PATH=/etc/sysrepo  -DCALL_TARGET_BINS_DIRECTLY=False -DGEN_LANGUAGE_BINDINGS:String=False "
